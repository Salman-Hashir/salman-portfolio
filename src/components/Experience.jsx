  ...
  return (
    <section id="experience" className="section-padding">
      ...
      <div style={{ maxWidth: '900px' }}>
        {jobs.map((job, index) => (
          <motion.div
            ...
            style={{ padding: '2.5rem 3rem', borderRadius: 'var(--radius-lg)', marginBottom: '2rem', transition: 'all 0.4s cubic-bezier(0.2, 0.8, 0.2, 1)' }}
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media(min-width: 768px) { .tl-item { display: grid; grid-template-columns: 200px 1fr; gap: 3rem; } }
        @media(max-width: 767px) { .tl-item { display: flex; flex-direction: column; gap: 1.5rem; } }
      `}} />
    </section>
  );
};
