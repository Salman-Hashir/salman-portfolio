...
export const DEFAULT_CONTENT = {
  siteSettings: {
    ...
    bio: 'IT Support Executive at LIFE Pharmacy Group, Dubai. I engineer robust IT systems, build web platforms that help people connect, and write dark Malayalam fiction — where technical precision meets cultural creativity.',
    ...
    aboutPara2: 'Currently serving as an IT Support Executive at LIFE Pharmacy Group in Dubai, with prior hands-on experience as a Technical Support Engineer at Asianet Satellite Communications and as an IT Instructor — I bring both the infrastructure mindset and the product instinct.',
    ...
    availability: 'Currently at LIFE Pharmacy Group, Dubai — open to collaborations',
    contactTitle: "Let's Build Something together.",
    contactSubtitle: 'Open to freelance development, creative collaborations, and exciting tech projects.',
    photoUrl: '/photo.jpg',
